...
class ReferralUtils:
    ...
    @staticmethod
    async def generate_referral_link(referral_code: str, base_url: str = "https://ramaera.com/signup") -> str:
        """
    ...
    async def generate_referral_marketing_materials(referral_code: str, user_name: str) -> Dict[str, str]:
        ...
        """
        base_url = "https://ramaera.com"
        referral_link = f"{base_url}/signup?ref={referral_code}"
        
        messages = {
            "email_subject": f"Join me on RAMAERA Hosting - Get started with {user_name}'s referral",
            "email_body": f"""
Hi there!

I've been using RAMAERA Hosting for my servers and I'm really impressed with their service. 
...
{user_name}
            """,
            "social_media": f"""
🚀 Amazing hosting experience with RAMAERA Hosting! 
...
#Hosting #WebServices #Referral
            """,
            "sms": f"Try RAMAERA Hosting! Use my code {referral_code} at {referral_link} for great hosting services."
        }
